  ...
  return (
    <aside className="w-64 bg-[#1a1a2e] text-white flex flex-col min-h-screen">
      <div className="px-6 py-5 border-b border-white/10">
        ...
        <p className="text-xs text-purple-300 mt-0.5">Tenant Portal</p>
      </div>
      ...
      <div className="px-4 py-4 border-t border-white/10 space-y-2">
        <Link
          href="/notifications"
          className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-purple-100 hover:bg-white/10 transition"
        >
